...
class handDetector():
    def __init__(self, mode = False, HandNos = 2, minDetectionConf = 0.5, minTrackingConf = 0.5):
        self.mode = mode
        ...
        self.hands = self.mpHands.Hands(self.mode, self.HandNos, min_detection_confidence=self.minDetectionConf, min_tracking_confidence=self.minTrackingConf)
    ...
    def findDistance(self, l1, l2, img, draw=True, r=15, t=3):
        ...
        if draw:
            ...
            cv.line(img, (x1,y1), (x2,y2), (255,0,0), t) #for line between thumb and index
